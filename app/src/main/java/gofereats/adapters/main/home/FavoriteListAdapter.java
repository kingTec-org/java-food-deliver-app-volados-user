...
public class FavoriteListAdapter extends RecyclerView.Adapter<SeeMoreListAdapter.Viewholder> implements ServiceListener {
    public @Inject
    ...
    /**
     * constructor for FavouriteListAdapter class
     *
     * @param context              context of an activity it is used in
     * @param RestaurantListModels RestaurantListModel Array List
     */

    public FavoriteListAdapter(Context context, ArrayList<RestaurantListModel> RestaurantListModels) {
    ...
    /**
     * on ItemClick Listener Interface
     */
   ...
   /* public class Viewholder extends RecyclerView.ViewHolder {
        ...
        private RelativeLayout rltSeeMore;
        private ImageView ivSeemore;
        private CustomTextView tvseemore;
