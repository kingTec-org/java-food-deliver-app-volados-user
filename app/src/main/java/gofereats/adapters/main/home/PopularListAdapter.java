...
public class PopularListAdapter extends RecyclerView.Adapter<SeeMoreListAdapter.Viewholder> implements ServiceListener {
    ...
    public PopularListAdapter(Context context, ArrayList<RestaurantListModel> RestaurantListModels) {
