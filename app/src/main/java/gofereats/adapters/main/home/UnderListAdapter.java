...
public class UnderListAdapter extends RecyclerView.Adapter<SeeMoreListAdapter.Viewholder> implements ServiceListener {
    ...
    /**
     * Under List Adapter constructor
     *
    ...
    public UnderListAdapter(Context context, ArrayList<RestaurantListModel> RestaurantListModels) {
