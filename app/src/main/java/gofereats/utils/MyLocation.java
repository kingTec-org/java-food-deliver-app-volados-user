...
public class MyLocation {
    ...
    public LocationListener locationListenerNetwork = new LocationListener() {
         ...
         *
         * @param location
         *            The new location, as AddCardActivity Location object.
         */
        @Override
        ...
        /**
         * Called when the provider status changes. This method is called when AddCardActivity
         * provider is unable to fetch AddCardActivity location or if the provider has
         * recently become available after AddCardActivity period of unavailability.
         *
         * @param provider
         *            the name of the location provider associated with this
         *            update.
