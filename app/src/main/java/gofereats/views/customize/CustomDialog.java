...
public class CustomDialog extends BaseDialogFragment {
    ...
    private int index = -1;
    private CustomTextView tvAllow;
    private CustomTextView tvDeny;
    ...
    public void initViews(View v) {
        super.initViews(v);
        CustomTextView tvTitle = v.findViewById(R.id.tv_dialog_title);
        CustomTextView tvMessage = v.findViewById(R.id.tv_message);
        this.tvAllow = v.findViewById(R.id.tv_allow);
        this.tvDeny = v.findViewById(R.id.tv_deny);
        RelativeLayout alertDialogLayout = v.findViewById(R.id.rlt_alert_dialog_layout);
        RelativeLayout prgresslayout = v.findViewById(R.id.llt_progress_dialog);
